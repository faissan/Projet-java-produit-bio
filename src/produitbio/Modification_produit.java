...
public class Modification_produit extends javax.swing.JFrame {
    ...
    private void modifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifierMouseClicked
        ...
        //date_production.setFormats("dd/MM/yyyy");
        String d_production = new SimpleDateFormat("dd/MM/yyyy").format(date_production.getDate());            
        
        //date_expiration.setFormats("dd/MM/yyyy");
        String d_expiration = new SimpleDateFormat("dd/MM/yyyy").format(date_expiration.getDate());            
    ...
    public org.jdesktop.swingx.JXDatePicker date_production;
